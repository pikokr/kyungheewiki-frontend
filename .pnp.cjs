...
var __defNormalProp$5 = (obj, key, value) =>
  key in obj
    ? __defProp$5(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
...
var __defNormalProp$4 = (obj, key, value) =>
  key in obj
    ? __defProp$4(obj, key, { enumerable: true, configurable: true, writable: true, value })
    : (obj[key] = value)
...
class ZipFS extends BasePortableFakeFS {
  ...
  async appendFilePromise(p, content, opts) {
    ...
    else if (typeof opts.flag === `undefined`) opts = __spreadValues$4({ flag: `a` }, opts)
...
var __objRest$1 = (source, exclude) => {
  ...
  for (var prop in source)
    if (__hasOwnProp$2.call(source, prop) && exclude.indexOf(prop) < 0) target[prop] = source[prop]
